...
export const reserveGuardCheckUiSchema = {
  eligibility: {
    'ui:title': 'Selected Reserve eligibility',
    'ui:description':
      "The Veteran must meet at least one of these criteria to be eligible for a burial flag through Selected Reserve service, per Section C(2) and C(3) of VA Form 27-2008 instructions.",
    reserveGuardCriteria: checkboxGroupUI({
      title:
        "Which of the following applies to the Veteran's Selected Reserve service?",
      hint:
        'Select all that apply. The Veteran must meet at least one of these criteria to be eligible for a burial flag through Selected Reserve service.',
      required: true,
...
export const reserveGuardCheckSchema = {
  type: 'object',
  properties: {
    eligibility: {
      type: 'object',
      required: ['reserveGuardCriteria'],
      properties: {
