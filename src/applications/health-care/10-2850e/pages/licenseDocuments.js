...
export const licenseDocumentsUiSchema = {
  supportingDocuments: {
    licenseDocuments: fileInputMultipleUI({
      ...
      hint:
        'Upload a clear, readable copy of each professional license you listed in the Licensure section. Include both sides of the license if information appears on both sides. Accepted file types: PDF, JPG, PNG. Maximum file size: 20 MB.',
      required: true,
      errorMessages: {
