...
export const deaCertificateUiSchema = {
  supportingDocuments: {
    deaCertificate: fileInputUI({
      ...
      hint: 'Upload a copy of your current DEA registration certificate. Both the front and back must be visible. Accepted file types: PDF, JPG, PNG. Maximum file size: 20 MB.',
      required: true,
      errorMessages: {
