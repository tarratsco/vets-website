...
export const attestationUiSchema = {
  attestation: {
    ...
    certifiesAccuracy: checkboxUI({
      ...
      errorMessages: {
        required: 'You must certify the accuracy of your information to submit this application.',
      },
    }),
    authorizesBackgroundInvestigation: checkboxUI({
      ...
      errorMessages: {
        required: 'You must authorize the background investigation to submit this application.',
      },
    }),
    authorizesReleaseOfInformation: checkboxUI({
      ...
      errorMessages: {
        required: 'You must authorize the release of information to submit this application.',
      },
    }),
    acknowledgesNpdbQuery: checkboxUI({
      ...
      errorMessages: {
        required: 'You must acknowledge the NPDB query to submit this application.',
      },
    }),
    electronicSignatureName: textUI({
      title: 'Type your full legal name to sign this application electronically',
      hint: 'By typing your name, you are signing this application with a legally valid electronic signature. Enter your name exactly as it appears in your application.',
      errorMessages: {
