...
export const attestationUiSchema = {
  attestation: {
    ...
    'ui:description':
      'Please read each statement carefully and check the box to confirm your agreement before signing.',
    certifiesAccuracy: checkboxUI({
      ...
      errorMessages: {
        required: 'You must certify the accuracy of your application to submit.',
      },
    }),
    authorizesBackgroundInvestigation: checkboxUI({
      ...
      errorMessages: {
        required: 'You must authorize the background investigation to submit.',
      },
    }),
    authorizesReleaseOfInformation: checkboxUI({
      ...
      errorMessages: {
        required: 'You must authorize the release of information to submit.',
      },
    }),
    ...
    electronicSignatureName: textUI({
      ...
      hint:
        'By typing your name, you are signing this application electronically. Your typed name must match the legal name you provided on this application.',
      errorMessages: {
    ...
    signatureDate: currentOrPastDateUI({
      ...
      hint: 'This is the date you are signing and submitting this application.',
      errorMessages: {
