...
export const CHANGE_TYPE_LABELS = {
  full_termination:
    'Full termination of enrollment (student is no longer enrolled)',
  partial_withdrawal:
...
export const REASON_FOR_CHANGE_LABELS = {
  ...
  reduction_no_reason:
    'Reduction in course load (no specific reason reported)',
...
export const CORRECTION_ITEM_LABELS = {
  ...
  enrollment_dates:
    'Enrollment period dates (begin or end date is incorrect)',
  enrollment_type:
