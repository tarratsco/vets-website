export const TITLE = 'Report an enrollment change';
export const SUBTITLE = 'VA Form 22-1999b';

export const CHANGE_TYPE_LABELS = {
  full_termination: 'Full termination of enrollment (student is no longer enrolled at your institution)',
  partial_withdrawal: 'Withdrawal from one or more courses (partial — student remains enrolled in other courses)',
  credit_hour_reduction: 'Reduction in credit hours (student is still enrolled)',
  correction: 'Correction to a previously submitted certification (fixing an error on the original VA Form 22-1999)',
};

export const CHANGE_TYPE_KEYS = Object.keys(CHANGE_TYPE_LABELS);
...
export const CORRECTION_ITEM_LABELS = {
  ...
  enrollment_type: 'Enrollment type (full-time/part-time status was reported incorrectly)',
...
export const CORRECTION_ITEM_KEYS = Object.keys(CORRECTION_ITEM_LABELS);
...
export const MITIGATING_CIRCUMSTANCES_LABELS = {
